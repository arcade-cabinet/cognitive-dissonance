  ...
  return _jsx('div', {
    ...
    children: _jsxs('div', {
      ...
      children: [
        ...
        _jsxs('div', {
          id: 'ui-layer',
          className: ui.screen === 'playing' ? '' : 'hidden',
          children: [
            _jsxs('div', {
              id: 'wave-announce',
              className: ui.showWave ? 'show' : '',
              children: [
                _jsx('div', { className: 'wt', id: 'wa-title', children: ui.waveTitle }),
                _jsx('div', { className: 'ws', id: 'wa-sub', children: ui.waveSub }),
              ],
            }),
            ui.boss &&
              _jsxs('div', {
                ...
                style: { display: 'block' },
                children: [
                  _jsx('div', { className: 'boss-name', id: 'boss-name', children: ui.boss.name }),
                  _jsx('div', {
                    id: 'boss-hp-outer',
                    children: _jsx('div', {
                      id: 'boss-hp-bar',
            ...
            _jsx('div', {
              id: 'hype-feed',
              children: ui.feed.map((item) =>
                _jsxs(
                  'div',
                  {
                    className: 'feed-item show',
                    children: [
                      _jsx('span', { className: 'feed-handle', children: item.handle }),
                      _jsx('span', { className: 'feed-text', children: item.text }),
                      _jsx('span', { className: 'feed-stat', children: item.stat }),
                    ],
                  },
                  item.id
                )
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('div', {
                  className: 'pu-icon',
                  id: 'pu-slow',
                  style: { opacity: ui.pu.slow > 0 ? 1 : 0.15 },
                  children: '\u23F3',
                }),
                _jsx('div', {
                  className: 'pu-icon',
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('div', {
                  className: 'hud-left',
                  children: [
                    _jsx('div', { children: 'PANIC' }),
                    _jsxs('div', {
                      className: 'meter-container',
                      children: [
                        _jsx('div', { className: 'marker', style: { left: '33%' } }),
                        _jsx('div', { className: 'marker', style: { left: '66%' } }),
                        _jsx('div', { id: 'panic-bar', style: { width: `${ui.panic}%` } }),
                      ],
                    }),
                    _jsxs('div', { id: 'combo-display', children: ['COMBO: x', ui.combo] }),
                  ],
                }),
                _jsx('div', {
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      children: [
                        'TIME: ',
                        _jsx('span', { id: 'time-display', children: Math.ceil(ui.time) }),
                        's',
                      ],
                    }),
                    _jsxs('div', {
                      children: [
                        'SCORE: ',
                        _jsx('span', { id: 'score-display', children: ui.score }),
                      ],
                    }),
                  ],
                }),
            ...
            _jsxs('div', {
              ...
              children: [
                _jsxs('button', {
                  ...
                  children: [
                    _jsx('div', { className: 'key-hint', children: '1' }),
                    'REALITY',
                    _jsx('span', { children: '\uD83E\uDDA0 HYPE' }),
                    _jsx('div', {
                ...
                _jsxs('button', {
                  ...
                  style: { touchAction: 'manipulation' },
                  children: [
                    _jsx('div', { className: 'key-hint', children: '2' }),
                    'HISTORY',
                    _jsx('span', { children: '\uD83D\uDCC8 GROWTH' }),
                    _jsx('div', {
                      className: 'cooldown-bar',
                      id: 'cd-history',
                ...
                _jsxs('button', {
                  ...
                  style: { touchAction: 'manipulation' },
                  children: [
                    _jsx('div', { className: 'key-hint', children: '3' }),
                    'LOGIC',
                    _jsx('span', { children: '\uD83E\uDD16 DEMOS' }),
                    _jsx('div', {
                      className: 'cooldown-bar',
                      id: 'cd-logic',
                ...
                _jsxs('button', {
                  ...
                  style: { touchAction: 'manipulation' },
                  children: [
                    _jsx('div', { className: 'key-hint', children: 'Q' }),
                    'NUKE',
                    _jsx('span', { children: '\uD83D\uDCA5 ALL' }),
                    _jsx('div', {
                      className: 'cooldown-bar',
                      id: 'cd-special',
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx('div', {
              className: 'subtitle',
              children: ui.screen === 'gameover' ? '' : 'D E L U X E',
            }),
            _jsxs('p', {
              id: 'overlay-desc',
              children: [
            ...
            ui.screen === 'start' &&
              _jsxs('p', {
                children: [
                  _jsx('b', { style: { color: '#e67e22' }, children: '1' }),
                  ' Reality \u00A0',
                  _jsx('b', { style: { color: '#2ecc71' }, children: '2' }),
                  ' History \u00A0',
                  _jsx('b', { style: { color: '#9b59b6' }, children: '3' }),
                  ' Logic \u00A0',
                  _jsx('b', { style: { color: '#e74c3c' }, children: 'Q' }),
                  ' Nuke',
                ],
              }),
            ui.screen === 'gameover' &&
              _jsxs('div', {
                id: 'end-stats',
                children: ['SCORE: ', ui.score, _jsx('br', {}), 'MAX COMBO: x', ui.maxCombo],
              }),
            _jsx('button', {
              type: 'button',
              className: 'start-btn',
