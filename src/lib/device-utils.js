 ...
 */
export function calculateViewport(baseWidth, baseHeight, deviceInfo) {
 ...
 */
function calculateSafeInsets(deviceInfo) {
 ...
 */
export function getUIScale(deviceInfo) {
 ...
 */
export function viewportToGame(x, y, viewport) {
  return {
 ...
 */
export function gameToViewport(x, y, viewport) {
  return {
