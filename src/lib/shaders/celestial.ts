...
export function createCelestialShaderMaterial(scene: BABYLON.Scene): BABYLON.ShaderMaterial {
  ...
  material.setFloat('u_cloud_density', 2.5);
  material.setFloat('u_glow_intensity', 1.5);
  material.setColor3('u_color1', BABYLON.Color3.FromHexString('#082f49'));
  material.setColor3('u_color2', BABYLON.Color3.FromHexString('#7dd3fc'));
