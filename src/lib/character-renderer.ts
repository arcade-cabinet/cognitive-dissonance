...
export class CharacterRenderer {
  ...
  speechText: Text | null = null;
  worryCloudGraphics: Graphics | null = null;
  lightningGraphics: Graphics | null = null;
  auraGraphics: Graphics | null = null;

  currentState: 'normal' | 'panic' | 'psyduck' = 'normal';
  time: number = 0;
   ...
   */
  update(panic: number, time: number): void {
    this.time = time;
   ...
   */
  private drawNormal(breathe: number, time: number): void {
   ...
   */
  private drawPanic(breathe: number, time: number, _panic: number): void {
    const g = new Graphics();
   ...
   */
  private drawPsyduck(breathe: number, time: number, panic: number): void {
    const g = new Graphics();
   ...
   */
  private drawSpeech(text: string, color: number, time: number): void {
