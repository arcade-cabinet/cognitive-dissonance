...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorScreenOrientation", path: "../../../node_modules/.pnpm/@capacitor+screen-orientation@8.0.1_@capacitor+core@8.3.0/node_modules/@capacitor/screen-orientation"),
